...
GAoptim = GA::select(y = y,x = x,family = family,k = 20,P = 100,ncores = 0,fitness = "rank",selection = "tournament")

# argument sanity checks here maybe?
#poisson but gave real numbers give them an error
...
#try paralellizing over or vectorizing mutation
...
#add in count for number of iterations
#output glm output of ideal model as well
#list results
#parallelize recombination
#while loop in wrappper function
#error handling there
#condition for comparing AIC difference less than 1 percent change (default) while loop
